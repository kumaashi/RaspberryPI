...
entry:
        mov  r0, vary      ; mov r3.8d, 0.5            # Load red varying AB partial to r0; set colour alpha to 1.0
        ...
        nop                ; mov r3.8c, r2 ;  loadc    # pack blue varying to color and load tile color r4
        v8adds r3, r3, r4  ; nop                       # add
