...
#define EMMC_BASE                  (SUBSYSTEM_BASE + 0x300000)
#define EMMC_ARG2                  ((volatile uint32_t *)(EMMC_BASE + 0x00))  //ACMD23 Argument 32
#define EMMC_BLKSIZECNT            ((volatile uint32_t *)(EMMC_BASE + 0x04))  //Block Size and Count 32
#define EMMC_ARG1                  ((volatile uint32_t *)(EMMC_BASE + 0x08))  //Argument 32
#define EMMC_CMDTM                 ((volatile uint32_t *)(EMMC_BASE + 0x0C))  //Command and Transfer Mode 32
#define EMMC_RESP0                 ((volatile uint32_t *)(EMMC_BASE + 0x10))  //Response bits 31 : 0 32
#define EMMC_RESP1                 ((volatile uint32_t *)(EMMC_BASE + 0x14))  //Response bits 63 : 32 32
#define EMMC_RESP2                 ((volatile uint32_t *)(EMMC_BASE + 0x18))  //Response bits 95 : 64 32
#define EMMC_RESP3                 ((volatile uint32_t *)(EMMC_BASE + 0x1C))  //Response bits 127 : 96 32
#define EMMC_DATA                  ((volatile uint32_t *)(EMMC_BASE + 0x20))  //Data 32
#define EMMC_STATUS                ((volatile uint32_t *)(EMMC_BASE + 0x24))  //Status 32
#define EMMC_CONTROL0              ((volatile uint32_t *)(EMMC_BASE + 0x28))  //Host Configuration bits 32
#define EMMC_CONTROL1              ((volatile uint32_t *)(EMMC_BASE + 0x2C))  //Host Configuration bits 32
#define EMMC_INTERRUPT             ((volatile uint32_t *)(EMMC_BASE + 0x30))  //Interrupt Flags 32
#define EMMC_IRPT_MASK             ((volatile uint32_t *)(EMMC_BASE + 0x34))  //Interrupt Flag Enable 32
#define EMMC_IRPT_EN               ((volatile uint32_t *)(EMMC_BASE + 0x38))  //Interrupt Generation Enable 32
#define EMMC_CONTROL2              ((volatile uint32_t *)(EMMC_BASE + 0x3C))  //Host Configuration bits 32
#define EMMC_FORCE_IRPT            ((volatile uint32_t *)(EMMC_BASE + 0x50))  //Force Interrupt Event 32
#define EMMC_BOOT_TIMEOUT          ((volatile uint32_t *)(EMMC_BASE + 0x70))  //Timeout in boot mode 32
#define EMMC_DBG_SEL               ((volatile uint32_t *)(EMMC_BASE + 0x74))  //Debug Bus Configuration 32
#define EMMC_EXRDFIFO_CFG          ((volatile uint32_t *)(EMMC_BASE + 0x80))  //Extension FIFO Configuration 32
#define EMMC_EXRDFIFO_EN           ((volatile uint32_t *)(EMMC_BASE + 0x84))  //Extension FIFO Enable 32
#define EMMC_TUNE_STEP             ((volatile uint32_t *)(EMMC_BASE + 0x88))  //Delay per card clock tuning step 32
#define EMMC_TUNE_STEPS_STD        ((volatile uint32_t *)(EMMC_BASE + 0x8C))  //Card clock tuning steps for SDR 32
#define EMMC_TUNE_STEPS_DDR        ((volatile uint32_t *)(EMMC_BASE + 0x90))  //Card clock tuning steps for DDR 32
#define EMMC_SPI_INT_SPT           ((volatile uint32_t *)(EMMC_BASE + 0xF0))  //SPI Interrupt Support 32
#define EMMC_SLOTISR_VER           ((volatile uint32_t *)(EMMC_BASE + 0xFC))  //Slot Interrupt Status and Version 32
